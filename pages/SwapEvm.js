      ...
      const SwapCard = () => {
          ...
          return (
              <View style={[styles.swapCardWrapper, { backgroundColor: theme.menuItemBG }]}>
                  ...
                  <Text style={{marginTop:10, color:theme.text,fontSize:19,fontWeight:'bold'}}> $ {topUSDValue?.amount}</Text>
                  {topToken == null ? "" :
                   <TouchableOpacity
                       onPress={()=>{onMaxValue()}}
      ...
      const SwapCard2 = () => {
          ...
          return (
              <View style={[styles.swapCardWrapper, { backgroundColor: theme.menuItemBG }]}>
                  ...
                  <View>
                  <View style={{ flexDirection: 'row', alignItems: 'center' , justifyContent:'space-between'}}>
                  <Text style={{marginTop:10, color:theme.text,fontSize:19,fontWeight:'bold'}}> $ {bottomUSDValue?.amount}</Text>
                  {bottomToken == null ? "" :
                   <TouchableOpacity
                       onPress={()=>{onMaxValue()}}
                       style={{ marginRight: 5, paddingHorizontal: 20, paddingVertical: 5, backgroundColor: 'gray', borderRadius: 5  }}
          ...
          <ScrollView style={[styles.mainWrapper, { backgroundColor: theme.screenBackgroud }]}>
              ...
              <View style={[styles.gasFlexWrapper,{ marginTop: 30 , marginBottom:30}]}>
                  ...
                  <View style={styles.gasFeeFlex}>
                      ...
                      <Text style={[styles.gasFee, {color: theme.emphasis, marginLeft:50, flexWrap:'wrap',flex:1}]}>{address?.replace(/^"|"$/g, '').substring(0,30)}</Text>
                  </View>
              </View>
