...
import { ScrollView, Alert, StyleSheet, View, Text,TouchableOpacity, Image } from 'react-native';
...
>
  <Text style={{ color: theme.text, }}>{activeNet?.networkName}{"  "}
  <Image
    source={
      theme.type == 'dark'
        ? require('../assets/dropw.png')
        : require('../assets/dropb.png')
    }
